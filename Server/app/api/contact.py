...
from ..models import (
    ...
    ExperienceItem, InterestItem, JourneyMilestone, Notification, Offer, Project, SiteSettings, SkillCategory,
)
from ..schemas import ContactIn, OfferIn
...
@router.post("/contact", dependencies=[Depends(rate_limited("contact", 5, 300))])
...
@router.post("/offers", dependencies=[Depends(rate_limited("offers", 5, 600))])
